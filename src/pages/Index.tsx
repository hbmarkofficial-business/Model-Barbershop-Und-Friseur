  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Augsburg | Model Barbershop und Friseur</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Model Barbershop und Friseur in Augsburg für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Model Barbershop und Friseur | Premium Barbershop Augsburg" />
        <meta
        ...
        <meta name="twitter:title" content="Model Barbershop und Friseur | Premium Barbershop Augsburg" />
        <meta
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "Barbershop",
            "name": "Model Barbershop und Friseur",
